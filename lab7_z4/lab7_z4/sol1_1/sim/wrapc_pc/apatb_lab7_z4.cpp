...
// wrapc file define:
#define AUTOTB_TVIN_a "../tv/cdatafile/c.lab7_z4.autotvin_a.dat"
#define AUTOTB_TVOUT_a "../tv/cdatafile/c.lab7_z4.autotvout_a.dat"
// wrapc file define:
#define AUTOTB_TVIN_b "../tv/cdatafile/c.lab7_z4.autotvin_b.dat"
#define AUTOTB_TVOUT_b "../tv/cdatafile/c.lab7_z4.autotvout_b.dat"
// wrapc file define:
#define AUTOTB_TVIN_c "../tv/cdatafile/c.lab7_z4.autotvin_c.dat"
#define AUTOTB_TVOUT_c "../tv/cdatafile/c.lab7_z4.autotvout_c.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_a "../tv/rtldatafile/rtl.lab7_z4.autotvout_a.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_b "../tv/rtldatafile/rtl.lab7_z4.autotvout_b.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_c "../tv/rtldatafile/rtl.lab7_z4.autotvout_c.dat"
...
extern "C" void lab7_z4_hw_stub_wrapper(volatile void *, volatile void *, volatile void *);
...
{
transaction<256> tr(128);
aesl_fh.read(AUTOTB_TVOUT_PC_a, tr.p, tr.tbytes);
tr.reorder();
tr.send<32>((char*)__xlx_apatb_param_a, 128);
}
#else
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<256> > a_pc_buffer(128);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 128; j < e; j += 1, ++i) {((long long*)__xlx_apatb_param_a)[j*4+0] = a_pc_buffer[i].range(63,0).to_int64();
...
tr.import<32>((char*)__xlx_apatb_param_a, 128, 0);
  }
tr.reorder();
...
tr.import<32>((char*)__xlx_apatb_param_b, 128, 0);
  }
tr.reorder();
...
tr.import<32>((char*)__xlx_apatb_param_c, 128, 0);
  }
tr.reorder();
...
lab7_z4_hw_stub_wrapper(__xlx_apatb_param_a, __xlx_apatb_param_b, __xlx_apatb_param_c);
