; ModuleID = 'C:/Xilinx_trn/HLS2023/lab7_z2/lab7_z2/sol2/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_lab7_z2_ir(double* %a, double* %b, double* %c) local_unnamed_addr #1 {
entry:
...
declare void @apatb_lab7_z2_hw([8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*)

define void @lab7_z2_hw_stub_wrapper([8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*, [8 x double]*) #5 {
entry:
  ...
  call void @lab7_z2_hw_stub(double* %51, double* %52, double* %53)
...
!6 = distinct !DISubprogram(name: "lab7_z2", linkageName: "_Z7lab7_z2PdS_S_", scope: !7, file: !7, line: 4, type: !8, isLocal: false, isDefinition: true, scopeLine: 5, flags: DIFlagPrototyped, isOptimized: false, unit: !16, variables: !4)
!7 = !DIFile(filename: "./source/lab7_z2.cpp", directory: "C:\5CXilinx_trn\5CHLS2023\5Clab7_z2")
!8 = !DISubroutineType(types: !9)
!9 = !{null, !10, !14, !14}
!10 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !11, size: 64)
!11 = !DIDerivedType(tag: DW_TAG_typedef, name: "dout_type", file: !12, line: 3, baseType: !13)
!12 = !DIFile(filename: "./source/lab7_z2.h", directory: "C:\5CXilinx_trn\5CHLS2023\5Clab7_z2")
...
!17 = !DIFile(filename: "C:/Xilinx_trn/HLS2023/lab7_z2/lab7_z2/sol2/.autopilot/db\5Clab7_z2.pp.0.cpp", directory: "C:\5CXilinx_trn\5CHLS2023\5Clab7_z2")
