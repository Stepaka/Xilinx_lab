...
set C_modelName {lab7_z1}
set C_modelType { void 0 }
set C_modelArgList {
	{ a int 32 regular {array 128 { 0 3 } 0 1 }  }
	{ b int 32 regular {array 128 { 1 3 } 1 1 }  }
	{ c int 32 regular {array 128 { 1 3 } 1 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_32_3_1_U1", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	a { ap_memory {  { a_address0 mem_address 1 7 }  { a_ce0 mem_ce 1 1 }  { a_we0 mem_we 1 1 }  { a_d0 mem_din 1 32 } } }
	b { ap_memory {  { b_address0 mem_address 1 7 }  { b_ce0 mem_ce 1 1 }  { b_q0 in_data 0 32 } } }
	c { ap_memory {  { c_address0 mem_address 1 7 }  { c_ce0 mem_ce 1 1 }  { c_q0 in_data 0 32 } } }
}
