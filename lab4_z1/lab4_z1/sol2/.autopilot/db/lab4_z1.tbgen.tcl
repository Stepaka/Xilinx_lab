...
set C_modelArgList {
	{ in_a int 32 regular {array 16384 { 1 3 } 1 1 }  }
	{ in_b int 32 regular {array 16384 { 1 3 } 1 1 }  }
	{ res int 32 regular {array 16384 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ in_a_address0 sc_out sc_lv 14 signal 0 } 
	{ in_a_ce0 sc_out sc_logic 1 signal 0 } 
	{ in_a_q0 sc_in sc_lv 32 signal 0 } 
	{ in_b_address0 sc_out sc_lv 14 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_local_block", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ap_local_block", "role": "default" }} , 
 	...
 	{ "name": "in_a_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "in_a", "role": "address0" }} , 
 	...
 	{ "name": "in_b_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "in_b", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "268435460", "EstimateLatencyMax" : "268435460",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set ArgLastReadFirstWriteLatency {
	lab4_z1 {
		in_a {Type I LastRead 0 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "268435460", "Max" : "268435460"}
	, {"Name" : "Interval", "Min" : "268435461", "Max" : "268435461"}
]}
...
set Spec2ImplPortList { 
	in_a { ap_memory {  { in_a_address0 mem_address 1 14 }  { in_a_ce0 mem_ce 1 1 }  { in_a_q0 mem_dout 0 32 } } }
	in_b { ap_memory {  { in_b_address0 mem_address 1 14 }  { in_b_ce0 mem_ce 1 1 }  { in_b_q0 mem_dout 0 32 } } }
