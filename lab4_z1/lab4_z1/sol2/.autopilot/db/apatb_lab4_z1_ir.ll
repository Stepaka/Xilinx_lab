...
entry:
  ...
  %in_a_copy = bitcast i8* %malloccall to [16384 x i32]*
  %malloccall1 = tail call i8* @malloc(i64 65536)
  %in_b_copy = bitcast i8* %malloccall1 to [16384 x i32]*
  %malloccall2 = tail call i8* @malloc(i64 65536)
  %res_copy = bitcast i8* %malloccall2 to [16384 x i32]*
  %0 = bitcast i32* %in_a to [16384 x i32]*
  %1 = bitcast i32* %in_b to [16384 x i32]*
  %2 = bitcast i32* %res to [16384 x i32]*
  call fastcc void @copy_in([16384 x i32]* %0, [16384 x i32]* %in_a_copy, [16384 x i32]* %1, [16384 x i32]* %in_b_copy, [16384 x i32]* %2, [16384 x i32]* %res_copy)
  %3 = getelementptr inbounds [16384 x i32], [16384 x i32]* %in_a_copy, i32 0, i32 0
  %4 = getelementptr inbounds [16384 x i32], [16384 x i32]* %in_b_copy, i32 0, i32 0
  %5 = getelementptr inbounds [16384 x i32], [16384 x i32]* %res_copy, i32 0, i32 0
  call void @apatb_lab4_z1_hw(i32* %3, i32* %4, i32* %5)
  call fastcc void @copy_out([16384 x i32]* %0, [16384 x i32]* %in_a_copy, [16384 x i32]* %1, [16384 x i32]* %in_b_copy, [16384 x i32]* %2, [16384 x i32]* %res_copy)
...
entry:
  %3 = bitcast i32* %0 to [16384 x i32]*
  %4 = bitcast i32* %1 to [16384 x i32]*
  %5 = bitcast i32* %2 to [16384 x i32]*
  call void @copy_out([16384 x i32]* null, [16384 x i32]* %3, [16384 x i32]* null, [16384 x i32]* %4, [16384 x i32]* null, [16384 x i32]* %5)
  %6 = bitcast [16384 x i32]* %3 to i32*
  %7 = bitcast [16384 x i32]* %4 to i32*
  %8 = bitcast [16384 x i32]* %5 to i32*
  call void @lab4_z1_hw_stub(i32* %6, i32* %7, i32* %8)
  call void @copy_in([16384 x i32]* null, [16384 x i32]* %3, [16384 x i32]* null, [16384 x i32]* %4, [16384 x i32]* null, [16384 x i32]* %5)
  ret void
}
