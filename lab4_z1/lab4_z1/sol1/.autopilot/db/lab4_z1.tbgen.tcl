...
set C_modelArgList {
	{ in_a int 32 regular {array 4 { 1 3 } 1 1 }  }
	{ in_b int 32 regular {array 4 { 1 3 } 1 1 }  }
	{ res int 32 regular {array 4 { 0 3 } 0 1 }  }
}
...
set ArgLastReadFirstWriteLatency {
	lab4_z1 {
		...
		in_b {Type I LastRead 3 FirstWrite -1}
...
set Spec2ImplPortList { 
	in_a { ap_memory {  { in_a_address0 mem_address 1 2 }  { in_a_ce0 mem_ce 1 1 }  { in_a_q0 mem_dout 0 32 } } }
	in_b { ap_memory {  { in_b_address0 mem_address 1 2 }  { in_b_ce0 mem_ce 1 1 }  { in_b_q0 mem_dout 0 32 } } }
