...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("in_a_address0", 4, hls_out, 0, "ap_memory", "mem_address", 1),
	Port_Property("in_a_ce0", 1, hls_out, 0, "ap_memory", "mem_ce", 1),
	Port_Property("in_a_q0", 32, hls_in, 0, "ap_memory", "mem_dout", 1),
	Port_Property("in_b_address0", 4, hls_out, 1, "ap_memory", "mem_address", 1),
	Port_Property("in_b_ce0", 1, hls_out, 1, "ap_memory", "mem_ce", 1),
	Port_Property("in_b_q0", 32, hls_in, 1, "ap_memory", "in_data", 1),
	Port_Property("in_b_address1", 4, hls_out, 1, "ap_memory", "MemPortADDR2", 1),
	Port_Property("in_b_ce1", 1, hls_out, 1, "ap_memory", "MemPortCE2", 1),
	Port_Property("in_b_q1", 32, hls_in, 1, "ap_memory", "MemPortDOUT2", 1),
