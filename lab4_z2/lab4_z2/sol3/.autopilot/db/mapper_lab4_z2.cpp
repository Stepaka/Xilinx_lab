...
extern "C" void lab4_z2(int*, int, int*, int*);
extern "C" void apatb_lab4_z2_hw(volatile void * __xlx_apatb_param_data_in, int __xlx_apatb_param_scale, volatile void * __xlx_apatb_param_data_out1, volatile void * __xlx_apatb_param_data_out2) {
  ...
  int __xlx_size_param_data_out1 = 16;
  ...
  int __xlx_size_param_data_out2 = 16;
  ...
  // DUT call
  lab4_z2(__xlx_data_in__input_buffer, __xlx_apatb_param_scale, __xlx_data_out1__input_buffer, __xlx_data_out2__input_buffer);
