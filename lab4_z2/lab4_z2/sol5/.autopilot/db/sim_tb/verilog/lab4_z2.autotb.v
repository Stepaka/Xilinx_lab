...
`define AUTOTB_DUT      lab4_z2
`define AUTOTB_DUT_INST AESL_inst_lab4_z2
`define AUTOTB_TOP      apatb_lab4_z2_top
`define AUTOTB_LAT_RESULT_FILE "lab4_z2.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "lab4_z2.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_lab4_z2_top
...
`define AUTOTB_TVIN_data_in  "./c.lab4_z2.autotvin_data_in.dat"
`define AUTOTB_TVIN_scale  "./c.lab4_z2.autotvin_scale.dat"
`define AUTOTB_TVIN_data_out1  "./c.lab4_z2.autotvin_data_out1.dat"
`define AUTOTB_TVIN_data_out2  "./c.lab4_z2.autotvin_data_out2.dat"
`define AUTOTB_TVIN_data_in_out_wrapc  "./rtl.lab4_z2.autotvin_data_in.dat"
`define AUTOTB_TVIN_scale_out_wrapc  "./rtl.lab4_z2.autotvin_scale.dat"
`define AUTOTB_TVIN_data_out1_out_wrapc  "./rtl.lab4_z2.autotvin_data_out1.dat"
`define AUTOTB_TVIN_data_out2_out_wrapc  "./rtl.lab4_z2.autotvin_data_out2.dat"
`define AUTOTB_TVOUT_data_out1  "./c.lab4_z2.autotvout_data_out1.dat"
`define AUTOTB_TVOUT_data_out2  "./c.lab4_z2.autotvout_data_out2.dat"
`define AUTOTB_TVOUT_data_out1_out_wrapc  "./impl_rtl.lab4_z2.autotvout_data_out1.dat"
`define AUTOTB_TVOUT_data_out2_out_wrapc  "./impl_rtl.lab4_z2.autotvout_data_out2.dat"
module `AUTOTB_TOP;
...
parameter LENGTH_data_out1 = 16;
parameter LENGTH_data_out2 = 16;
...
wire    [3 : 0]    arraydata_in_address0, arraydata_in_address1;
...
wire    [3 : 0]    arraydata_out1_address0, arraydata_out1_address1;
...
wire    [3 : 0]    arraydata_out2_address0, arraydata_out2_address1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    fp1 = $fopen("./rtl.lab4_z2.autotvout_data_out1.dat", "r");
    fp2 = $fopen("./impl_rtl.lab4_z2.autotvout_data_out1.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.lab4_z2.autotvout_data_out1.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.lab4_z2.autotvout_data_out1.dat\"!");
    else begin
        $display("Comparing rtl.lab4_z2.autotvout_data_out1.dat with impl_rtl.lab4_z2.autotvout_data_out1.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.lab4_z2.autotvout_data_out2.dat", "r");
    fp2 = $fopen("./impl_rtl.lab4_z2.autotvout_data_out2.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.lab4_z2.autotvout_data_out2.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.lab4_z2.autotvout_data_out2.dat\"!");
    else begin
        $display("Comparing rtl.lab4_z2.autotvout_data_out2.dat with impl_rtl.lab4_z2.autotvout_data_out2.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
