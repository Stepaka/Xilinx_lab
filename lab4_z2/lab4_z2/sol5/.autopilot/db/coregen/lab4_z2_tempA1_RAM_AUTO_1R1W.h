...
#ifndef _lab4_z2_tempA1_RAM_AUTO_1R1W_H_
#define _lab4_z2_tempA1_RAM_AUTO_1R1W_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "lab4_z2_tempA1_RAM_AUTO_1R1W_memcore.h"

SC_MODULE(lab4_z2_tempA1_RAM_AUTO_1R1W) {
...
protected:
    ...
    lab4_z2_tempA1_RAM_AUTO_1R1W_memcore* lab4_z2_tempA1_RAM_AUTO_1R1W_memcore_U;
...
public:
    ...
    SC_CTOR(lab4_z2_tempA1_RAM_AUTO_1R1W) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        lab4_z2_tempA1_RAM_AUTO_1R1W_memcore_U = new lab4_z2_tempA1_RAM_AUTO_1R1W_memcore("lab4_z2_tempA1_RAM_AUTO_1R1W_memcore_U");
        lab4_z2_tempA1_RAM_AUTO_1R1W_memcore_U->clk      ( clk );
        lab4_z2_tempA1_RAM_AUTO_1R1W_memcore_U->reset    ( reset );
        lab4_z2_tempA1_RAM_AUTO_1R1W_memcore_U->ce0      ( i_ce0 );
        lab4_z2_tempA1_RAM_AUTO_1R1W_memcore_U->we0      ( i_we0 );
        lab4_z2_tempA1_RAM_AUTO_1R1W_memcore_U->address0 ( memcore_iaddr );
        lab4_z2_tempA1_RAM_AUTO_1R1W_memcore_U->d0       ( i_d0 );
        lab4_z2_tempA1_RAM_AUTO_1R1W_memcore_U->q0       ( i_q0 );

        lab4_z2_tempA1_RAM_AUTO_1R1W_memcore_U->ce1      ( t_ce0 );
        lab4_z2_tempA1_RAM_AUTO_1R1W_memcore_U->we1      ( t_we0 );
        lab4_z2_tempA1_RAM_AUTO_1R1W_memcore_U->address1 ( memcore_taddr );
        lab4_z2_tempA1_RAM_AUTO_1R1W_memcore_U->d1       ( t_d0 );
        lab4_z2_tempA1_RAM_AUTO_1R1W_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "lab4_z2_tempA1_RAM_AUTO_1R1W.trace");
            // ports
