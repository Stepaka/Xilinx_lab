...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.lab4_z2.autotvin_data_in.dat"
         "c.lab4_z2.autotvin_scale.dat"
         "c.lab4_z2.autotvin_data_out1.dat"
         "c.lab4_z2.autotvin_data_out2.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.lab4_z2.autotvout_data_out1.dat"
         "rtl.lab4_z2.autotvout_data_out2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
