...
// wrapc file define:
#define AUTOTB_TVIN_data_in "../tv/cdatafile/c.lab4_z2.autotvin_data_in.dat"
#define AUTOTB_TVOUT_data_in "../tv/cdatafile/c.lab4_z2.autotvout_data_in.dat"
// wrapc file define:
#define AUTOTB_TVIN_scale "../tv/cdatafile/c.lab4_z2.autotvin_scale.dat"
#define AUTOTB_TVOUT_scale "../tv/cdatafile/c.lab4_z2.autotvout_scale.dat"
// wrapc file define:
#define AUTOTB_TVIN_data_out1 "../tv/cdatafile/c.lab4_z2.autotvin_data_out1.dat"
#define AUTOTB_TVOUT_data_out1 "../tv/cdatafile/c.lab4_z2.autotvout_data_out1.dat"
// wrapc file define:
#define AUTOTB_TVIN_data_out2 "../tv/cdatafile/c.lab4_z2.autotvin_data_out2.dat"
#define AUTOTB_TVOUT_data_out2 "../tv/cdatafile/c.lab4_z2.autotvout_data_out2.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_data_in "../tv/rtldatafile/rtl.lab4_z2.autotvout_data_in.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_scale "../tv/rtldatafile/rtl.lab4_z2.autotvout_scale.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_data_out1 "../tv/rtldatafile/rtl.lab4_z2.autotvout_data_out1.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_data_out2 "../tv/rtldatafile/rtl.lab4_z2.autotvout_data_out2.dat"
...
static bool RTLOutputCheckAndReplacement(std::string &AESL_token, std::string PortName) {
  ...
  return err;}
extern "C" void lab4_z2_hw_stub_wrapper(volatile void *, int, volatile void *, volatile void *);

extern "C" void apatb_lab4_z2_hw(volatile void * __xlx_apatb_param_data_in, int __xlx_apatb_param_scale, volatile void * __xlx_apatb_param_data_out1, volatile void * __xlx_apatb_param_data_out2) {
...
tr.reorder();
tr.send<4>((char*)__xlx_apatb_param_data_out1, 16);
}
#else
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > data_out1_pc_buffer(16);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 16; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_data_out1)[j*4+0] = data_out1_pc_buffer[i].range(7, 0).to_int64();
...
tr.reorder();
tr.send<4>((char*)__xlx_apatb_param_data_out2, 16);
}
#else
{
      static ifstream rtl_tv_out_file;
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > data_out2_pc_buffer(16);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 16; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_data_out2)[j*4+0] = data_out2_pc_buffer[i].range(7, 0).to_int64();
...
tr.import<4>((char*)__xlx_apatb_param_data_in, 16, 0);
  }
tr.reorder();
...
tr.import<4>((char*)__xlx_apatb_param_data_out1, 16, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_data_out1, tr.p, tr.tbytes);
}

  tcl_file.set_num(16, &tcl_file.data_out1_depth);
#else
...
tr.import<4>((char*)__xlx_apatb_param_data_out2, 16, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_data_out2, tr.p, tr.tbytes);
}

  tcl_file.set_num(16, &tcl_file.data_out2_depth);
#else
...
lab4_z2_hw_stub_wrapper(__xlx_apatb_param_data_in, __xlx_apatb_param_scale, __xlx_apatb_param_data_out1, __xlx_apatb_param_data_out2);
