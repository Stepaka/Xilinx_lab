...
#define AUTOTB_TVOUT_a "../tv/cdatafile/c.kp_502_15.autotvout_a.dat"
// wrapc file define:
#define AUTOTB_TVIN_b "../tv/cdatafile/c.kp_502_15.autotvin_b.dat"
#define AUTOTB_TVOUT_b "../tv/cdatafile/c.kp_502_15.autotvout_b.dat"
// wrapc file define:
#define AUTOTB_TVIN_c "../tv/cdatafile/c.kp_502_15.autotvin_c.dat"
#define AUTOTB_TVOUT_c "../tv/cdatafile/c.kp_502_15.autotvout_c.dat"
// wrapc file define:
#define AUTOTB_TVIN_x "../tv/cdatafile/c.kp_502_15.autotvin_x.dat"
#define AUTOTB_TVOUT_x "../tv/cdatafile/c.kp_502_15.autotvout_x.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_r "../tv/rtldatafile/rtl.kp_502_15.autotvout_r.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_a "../tv/rtldatafile/rtl.kp_502_15.autotvout_a.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_b "../tv/rtldatafile/rtl.kp_502_15.autotvout_b.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_c "../tv/rtldatafile/rtl.kp_502_15.autotvout_c.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_x "../tv/rtldatafile/rtl.kp_502_15.autotvout_x.dat"
...
static bool RTLOutputCheckAndReplacement(std::string &AESL_token, std::string PortName) {
  ...
  return err;}
extern "C" void kp_502_15_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
...
{
transaction<32> tr(8);
aesl_fh.read(AUTOTB_TVOUT_PC_r, tr.p, tr.tbytes);
tr.reorder();
tr.send<4>((char*)__xlx_apatb_param_r, 8);
}
#else
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > r_pc_buffer(8);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 8; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_r)[j*4+0] = r_pc_buffer[i].range(7, 0).to_int64();
((char*)__xlx_apatb_param_r)[j*4+1] = r_pc_buffer[i].range(15, 8).to_int64();
((char*)__xlx_apatb_param_r)[j*4+2] = r_pc_buffer[i].range(23, 16).to_int64();
((char*)__xlx_apatb_param_r)[j*4+3] = r_pc_buffer[i].range(31, 24).to_int64();
}}}
        } // end transaction
      } // end file is good
...
unsigned __xlx_offset_byte_param_r = 0;
#ifdef USE_BINARY_TV_FILE
{
aesl_fh.touch(AUTOTB_TVIN_r, 'b');
transaction<32> tr(8);
  __xlx_offset_byte_param_r = 0*4;
  if (__xlx_apatb_param_r) {
tr.import<4>((char*)__xlx_apatb_param_r, 8, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_r, tr.p, tr.tbytes);
}

  tcl_file.set_num(8, &tcl_file.r_depth);
#else
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_r)[j];
...
tr.import<4>((char*)__xlx_apatb_param_a, 8, 0);
  }
tr.reorder();
...
tr.import<4>((char*)__xlx_apatb_param_b, 8, 0);
  }
tr.reorder();
...
tr.import<4>((char*)__xlx_apatb_param_c, 8, 0);
  }
tr.reorder();
...
tr.import<4>((char*)__xlx_apatb_param_x, 8, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_x, tr.p, tr.tbytes);
}

  tcl_file.set_num(8, &tcl_file.x_depth);
#else
...
kp_502_15_hw_stub_wrapper(__xlx_apatb_param_r, __xlx_apatb_param_a, __xlx_apatb_param_b, __xlx_apatb_param_c, __xlx_apatb_param_x);
CodeState = DUMP_OUTPUTS;
#ifdef USE_BINARY_TV_FILE
{
aesl_fh.touch(AUTOTB_TVOUT_r, 'b');
transaction<32> tr(8);
  __xlx_offset_byte_param_r = 0*4;
  if (__xlx_apatb_param_r) {
tr.import<4>((char*)__xlx_apatb_param_r, 8, 0);
...
tr.reorder();
aesl_fh.write(AUTOTB_TVOUT_r, tr.p, tr.tbytes);
}
