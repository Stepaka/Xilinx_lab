...
set portList { 
	...
	{ a_address1 sc_out sc_lv 3 signal 1 } 
	...
	{ b_address1 sc_out sc_lv 3 signal 2 } 
...
set Spec2ImplPortList { 
	r { ap_memory {  { r_address0 mem_address 1 3 }  { r_ce0 mem_ce 1 1 }  { r_we0 mem_we 1 1 }  { r_d0 mem_din 1 32 }  { r_address1 MemPortADDR2 1 3 }  { r_ce1 MemPortCE2 1 1 }  { r_we1 MemPortWE2 1 1 }  { r_d1 MemPortDIN2 1 32 } } }
	a { ap_memory {  { a_address0 mem_address 1 3 }  { a_ce0 mem_ce 1 1 }  { a_q0 in_data 0 32 }  { a_address1 MemPortADDR2 1 3 }  { a_ce1 MemPortCE2 1 1 }  { a_q1 in_data 0 32 } } }
	b { ap_memory {  { b_address0 mem_address 1 3 }  { b_ce0 mem_ce 1 1 }  { b_q0 in_data 0 32 }  { b_address1 MemPortADDR2 1 3 }  { b_ce1 MemPortCE2 1 1 }  { b_q1 in_data 0 32 } } }
	c { ap_memory {  { c_address0 mem_address 1 3 }  { c_ce0 mem_ce 1 1 }  { c_q0 in_data 0 32 }  { c_address1 MemPortADDR2 1 3 }  { c_ce1 MemPortCE2 1 1 }  { c_q1 in_data 0 32 } } }
	x { ap_memory {  { x_address0 mem_address 1 3 }  { x_ce0 mem_ce 1 1 }  { x_q0 in_data 0 32 }  { x_address1 MemPortADDR2 1 3 }  { x_ce1 MemPortCE2 1 1 }  { x_q1 in_data 0 32 } } }
}
