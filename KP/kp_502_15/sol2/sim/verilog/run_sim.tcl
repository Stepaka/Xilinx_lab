...
if {[file isfile kp_502_15.autotvin.dat]} {
	file delete -force kp_502_15.autotvin.dat
}

if {[file isfile kp_502_15.autotvout.dat]} {
	file delete -force kp_502_15.autotvout.dat
}
