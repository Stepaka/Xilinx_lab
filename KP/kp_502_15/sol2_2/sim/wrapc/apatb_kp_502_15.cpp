...
static bool RTLOutputCheckAndReplacement(std::string &AESL_token, std::string PortName) {
  ...
  return err;}
extern "C" void kp_502_15_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
...
tr.reorder();
tr.send<4>((char*)__xlx_apatb_param_r_0, 4);
}
#else
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > r_0_pc_buffer(4);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 4; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_r_0)[j*4+0] = r_0_pc_buffer[i].range(7, 0).to_int64();
...
tr.reorder();
tr.send<4>((char*)__xlx_apatb_param_r_1, 4);
}
#else
{
      static ifstream rtl_tv_out_file;
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > r_1_pc_buffer(4);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 4; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_r_1)[j*4+0] = r_1_pc_buffer[i].range(7, 0).to_int64();
...
tr.import<4>((char*)__xlx_apatb_param_r_0, 4, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_r_0, tr.p, tr.tbytes);
}

  tcl_file.set_num(4, &tcl_file.r_0_depth);
#else
...
tr.import<4>((char*)__xlx_apatb_param_r_1, 4, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_r_1, tr.p, tr.tbytes);
}

  tcl_file.set_num(4, &tcl_file.r_1_depth);
#else
...
tr.import<4>((char*)__xlx_apatb_param_x_0, 4, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_x_0, tr.p, tr.tbytes);
}

  tcl_file.set_num(4, &tcl_file.x_0_depth);
#else
...
tr.import<4>((char*)__xlx_apatb_param_x_1, 4, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_x_1, tr.p, tr.tbytes);
}

  tcl_file.set_num(4, &tcl_file.x_1_depth);
#else
...
kp_502_15_hw_stub_wrapper(__xlx_apatb_param_r_0, __xlx_apatb_param_r_1, __xlx_apatb_param_a_0, __xlx_apatb_param_a_1, __xlx_apatb_param_b_0, __xlx_apatb_param_b_1, __xlx_apatb_param_c_0, __xlx_apatb_param_c_1, __xlx_apatb_param_x_0, __xlx_apatb_param_x_1);
