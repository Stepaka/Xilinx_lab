...
`define AUTOTB_TVIN_r  "./c.kp_502_15.autotvin_r.dat"
`define AUTOTB_TVIN_a  "./c.kp_502_15.autotvin_a.dat"
`define AUTOTB_TVIN_b  "./c.kp_502_15.autotvin_b.dat"
`define AUTOTB_TVIN_c  "./c.kp_502_15.autotvin_c.dat"
`define AUTOTB_TVIN_x  "./c.kp_502_15.autotvin_x.dat"
`define AUTOTB_TVIN_r_out_wrapc  "./rtl.kp_502_15.autotvin_r.dat"
`define AUTOTB_TVIN_a_out_wrapc  "./rtl.kp_502_15.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "./rtl.kp_502_15.autotvin_b.dat"
`define AUTOTB_TVIN_c_out_wrapc  "./rtl.kp_502_15.autotvin_c.dat"
`define AUTOTB_TVIN_x_out_wrapc  "./rtl.kp_502_15.autotvin_x.dat"
`define AUTOTB_TVOUT_r  "./c.kp_502_15.autotvout_r.dat"
`define AUTOTB_TVOUT_r_out_wrapc  "./impl_rtl.kp_502_15.autotvout_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 3;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 7;
parameter LENGTH_r = 2;
parameter LENGTH_a = 2;
parameter LENGTH_b = 2;
parameter LENGTH_c = 2;
parameter LENGTH_x = 2;
...
wire [16 - 1 : 0]    arrayr_we0, arrayr_we1;
wire    [0 : 0]    arrayr_address0, arrayr_address1;
wire    [127 : 0]    arrayr_din0, arrayr_din1;
wire    [127 : 0]    arrayr_dout0, arrayr_dout1;
wire    arrayr_ready;
wire    arrayr_done;
...
assign arrayr_we0[4] = r_we0;
assign arrayr_we0[5] = r_we0;
assign arrayr_we0[6] = r_we0;
assign arrayr_we0[7] = r_we0;
assign arrayr_we0[8] = r_we0;
assign arrayr_we0[9] = r_we0;
assign arrayr_we0[10] = r_we0;
assign arrayr_we0[11] = r_we0;
assign arrayr_we0[12] = r_we0;
assign arrayr_we0[13] = r_we0;
assign arrayr_we0[14] = r_we0;
assign arrayr_we0[15] = r_we0;
...
wire [16 - 1 : 0]    arrayx_we0, arrayx_we1;
wire    [0 : 0]    arrayx_address0, arrayx_address1;
wire    [127 : 0]    arrayx_din0, arrayx_din1;
wire    [127 : 0]    arrayx_dout0, arrayx_dout1;
wire    arrayx_ready;
wire    arrayx_done;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    fp1 = $fopen("./rtl.kp_502_15.autotvout_r.dat", "r");
    fp2 = $fopen("./impl_rtl.kp_502_15.autotvout_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.kp_502_15.autotvout_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.kp_502_15.autotvout_r.dat\"!");
    else begin
        $display("Comparing rtl.kp_502_15.autotvout_r.dat with impl_rtl.kp_502_15.autotvout_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
