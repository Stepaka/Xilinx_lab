...
set C_modelArgList {
	...
	{ C int 64 regular {array 8 { 1 3 } 1 1 }  }
	{ X1 int 64 regular {array 8 { 0 3 } 0 1 }  }
	{ X2 int 64 regular {array 8 { 0 3 } 0 1 }  }
	{ D int 64 regular {array 8 { 0 3 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "241", "EstimateLatencyMax" : "1281",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Loop" : [
			{"Name" : "Loop", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "221", "FirstState" : "ap_ST_fsm_state2", "LastState" : ["ap_ST_fsm_state161"], "QuitState" : ["ap_ST_fsm_state2"], "PreState" : ["ap_ST_fsm_state1"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dmul_64ns_64ns_64_8_max_dsp_1_U3", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dmul_64ns_64ns_64_8_max_dsp_1_U4", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ddiv_64ns_64ns_64_59_no_dsp_1_U5", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ddiv_64ns_64ns_64_59_no_dsp_1_U6", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dcmp_64ns_64ns_1_2_no_dsp_1_U7", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dsqrt_64ns_64ns_64_57_no_dsp_1_U8", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	kp_502_7 {
		...
		C {Type I LastRead 9 FirstWrite -1}
		X1 {Type O LastRead -1 FirstWrite 29}
		X2 {Type O LastRead -1 FirstWrite 29}
		D {Type O LastRead -1 FirstWrite 27}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "241", "Max" : "1281"}
	, {"Name" : "Interval", "Min" : "242", "Max" : "1282"}
]}
...
set Spec2ImplPortList { 
	...
	C { ap_memory {  { C_address0 mem_address 1 3 }  { C_ce0 mem_ce 1 1 }  { C_q0 mem_dout 0 64 } } }
	X1 { ap_memory {  { X1_address0 mem_address 1 3 }  { X1_ce0 mem_ce 1 1 }  { X1_we0 mem_we 1 1 }  { X1_d0 mem_din 1 64 } } }
	X2 { ap_memory {  { X2_address0 mem_address 1 3 }  { X2_ce0 mem_ce 1 1 }  { X2_we0 mem_we 1 1 }  { X2_d0 mem_din 1 64 } } }
	D { ap_memory {  { D_address0 mem_address 1 3 }  { D_ce0 mem_ce 1 1 }  { D_we0 mem_we 1 1 }  { D_d0 mem_din 1 64 } } }
}
