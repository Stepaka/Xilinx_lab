...
{
transaction<128> tr(4);
aesl_fh.read(AUTOTB_TVOUT_PC_X1, tr.p, tr.tbytes);
tr.reorder();
tr.send<16>((char*)__xlx_apatb_param_X1, 4);
}
#else
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<128> > X1_pc_buffer(4);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 4; j < e; j += 1, ++i) {((long long*)__xlx_apatb_param_X1)[j*2+0] = X1_pc_buffer[i].range(63,0).to_int64();
...
tr.reorder();
tr.send<16>((char*)__xlx_apatb_param_X2, 4);
}
#else
{
      static ifstream rtl_tv_out_file;
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<128> > X2_pc_buffer(4);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 4; j < e; j += 1, ++i) {((long long*)__xlx_apatb_param_X2)[j*2+0] = X2_pc_buffer[i].range(63,0).to_int64();
...
tr.reorder();
tr.send<16>((char*)__xlx_apatb_param_D, 4);
}
#else
{
      static ifstream rtl_tv_out_file;
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<128> > D_pc_buffer(4);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 4; j < e; j += 1, ++i) {((long long*)__xlx_apatb_param_D)[j*2+0] = D_pc_buffer[i].range(63,0).to_int64();
...
tr.import<16>((char*)__xlx_apatb_param_A, 4, 0);
  }
tr.reorder();
...
tr.import<16>((char*)__xlx_apatb_param_B, 4, 0);
  }
tr.reorder();
...
tr.import<16>((char*)__xlx_apatb_param_C, 4, 0);
  }
tr.reorder();
...
tr.import<16>((char*)__xlx_apatb_param_X1, 4, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_X1, tr.p, tr.tbytes);
}

  tcl_file.set_num(4, &tcl_file.X1_depth);
#else
...
tr.import<16>((char*)__xlx_apatb_param_X2, 4, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_X2, tr.p, tr.tbytes);
}

  tcl_file.set_num(4, &tcl_file.X2_depth);
#else
...
tr.import<16>((char*)__xlx_apatb_param_D, 4, 0);
  }
tr.reorder();
