; ModuleID = 'G:/Xilinx_lab/KP_502_7/kp_502_7/sol2_4/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  %A_copy1 = alloca [4 x i128], align 512
  %B_copy2 = alloca [4 x i128], align 512
  %C_copy3 = alloca [4 x i128], align 512
  %X1_copy4 = alloca [4 x i128], align 512
  %X2_copy5 = alloca [4 x i128], align 512
  %D_copy6 = alloca [4 x i128], align 512
  ...
  call void @copy_in([8 x double]* %0, [4 x i128]* nonnull align 512 %A_copy1, [8 x double]* %1, [4 x i128]* nonnull align 512 %B_copy2, [8 x double]* %2, [4 x i128]* nonnull align 512 %C_copy3, [8 x double]* %3, [4 x i128]* nonnull align 512 %X1_copy4, [8 x double]* %4, [4 x i128]* nonnull align 512 %X2_copy5, [8 x double]* %5, [4 x i128]* nonnull align 512 %D_copy6)
  %A_copy.gep7 = getelementptr [4 x i128], [4 x i128]* %A_copy1, i64 0, i32 0
  %B_copy.gep8 = getelementptr [4 x i128], [4 x i128]* %B_copy2, i64 0, i32 0
  %C_copy.gep9 = getelementptr [4 x i128], [4 x i128]* %C_copy3, i64 0, i32 0
  %X1_copy.gep10 = getelementptr [4 x i128], [4 x i128]* %X1_copy4, i64 0, i32 0
  %X2_copy.gep11 = getelementptr [4 x i128], [4 x i128]* %X2_copy5, i64 0, i32 0
  %D_copy.gep12 = getelementptr [4 x i128], [4 x i128]* %D_copy6, i64 0, i32 0
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %A_copy.gep7, i32 0, i32 1, i32 0) ], !dbg !5
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %B_copy.gep8, i32 0, i32 1, i32 0) ], !dbg !595
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %C_copy.gep9, i32 0, i32 1, i32 0) ], !dbg !595
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %X1_copy.gep10, i32 0, i32 1, i32 0) ], !dbg !595
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %X2_copy.gep11, i32 0, i32 1, i32 0) ], !dbg !595
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %D_copy.gep12, i32 0, i32 1, i32 0) ], !dbg !595
  call void @apatb_kp_502_7_hw([4 x i128]* %A_copy1, [4 x i128]* %B_copy2, [4 x i128]* %C_copy3, [4 x i128]* %X1_copy4, [4 x i128]* %X2_copy5, [4 x i128]* %D_copy6)
  call void @copy_out([8 x double]* %0, [4 x i128]* nonnull align 512 %A_copy1, [8 x double]* %1, [4 x i128]* nonnull align 512 %B_copy2, [8 x double]* %2, [4 x i128]* nonnull align 512 %C_copy3, [8 x double]* %3, [4 x i128]* nonnull align 512 %X1_copy4, [8 x double]* %4, [4 x i128]* nonnull align 512 %X2_copy5, [8 x double]* %5, [4 x i128]* nonnull align 512 %D_copy6)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a8f64.3.4([4 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [8 x double]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
  %2 = icmp eq [4 x i128]* %0, null
...
for.loop:                                         ; preds = %for.loop, %copy
  ...
  %dst.addr1 = getelementptr [4 x i128], [4 x i128]* %0, i64 0, i64 %7
  %src.addr = getelementptr [8 x double], [8 x double]* %1, i64 0, i64 %for.loop.idx1
  %8 = load double, double* %src.addr, align 8
  %9 = bitcast double %8 to i64
  %10 = add i64 %6, 63
  %11 = load i128, i128* %dst.addr1, align 16
  %12 = zext i64 %6 to i128
  %13 = zext i64 %9 to i128
  %14 = shl i128 %13, %12
  %15 = zext i64 %10 to i128
  %16 = add nuw nsw i128 %15, 1
  %17 = shl i128 1, %16
  %18 = icmp uge i128 %16, 128
  %19 = select i1 %18, i128 0, i128 %17
  %20 = shl i128 1, %12
  %21 = sub i128 %19, %20
  %22 = xor i128 %21, -1
  %23 = and i128 %11, %22
  %24 = or i128 %23, %14
  store i128 %24, i128* %dst.addr1, align 16
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([8 x double]* readonly "orig.arg.no"="0", [4 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [8 x double]* readonly "orig.arg.no"="2", [4 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [8 x double]* readonly "orig.arg.no"="4", [4 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5", [8 x double]* readonly "orig.arg.no"="6", [4 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7", [8 x double]* readonly "orig.arg.no"="8", [4 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="9", [8 x double]* readonly "orig.arg.no"="10", [4 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="11") #3 {
entry:
  call void @onebyonecpy_hls.p0a8f64.3.4([4 x i128]* align 512 %1, [8 x double]* %0)
  call void @onebyonecpy_hls.p0a8f64.3.4([4 x i128]* align 512 %3, [8 x double]* %2)
  call void @onebyonecpy_hls.p0a8f64.3.4([4 x i128]* align 512 %5, [8 x double]* %4)
  call void @onebyonecpy_hls.p0a8f64.3.4([4 x i128]* align 512 %7, [8 x double]* %6)
  call void @onebyonecpy_hls.p0a8f64.3.4([4 x i128]* align 512 %9, [8 x double]* %8)
  call void @onebyonecpy_hls.p0a8f64.3.4([4 x i128]* align 512 %11, [8 x double]* %10)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a8f64.9.10([8 x double]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [4 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
  %2 = icmp eq [8 x double]* %0, null
  %3 = icmp eq [4 x i128]* %1, null
  %4 = or i1 %2, %3
  br i1 %4, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %copy
  ...
  %6 = mul i64 64, %5
  %7 = udiv i64 %for.loop.idx1, 2
  %src.addr1 = getelementptr [4 x i128], [4 x i128]* %1, i64 0, i64 %7
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([8 x double]* "orig.arg.no"="0", [4 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [8 x double]* "orig.arg.no"="2", [4 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [8 x double]* "orig.arg.no"="4", [4 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5", [8 x double]* "orig.arg.no"="6", [4 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7", [8 x double]* "orig.arg.no"="8", [4 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="9", [8 x double]* "orig.arg.no"="10", [4 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="11") #4 {
entry:
  call void @onebyonecpy_hls.p0a8f64.9.10([8 x double]* %0, [4 x i128]* align 512 %1)
  call void @onebyonecpy_hls.p0a8f64.9.10([8 x double]* %2, [4 x i128]* align 512 %3)
  call void @onebyonecpy_hls.p0a8f64.9.10([8 x double]* %4, [4 x i128]* align 512 %5)
  call void @onebyonecpy_hls.p0a8f64.9.10([8 x double]* %6, [4 x i128]* align 512 %7)
  call void @onebyonecpy_hls.p0a8f64.9.10([8 x double]* %8, [4 x i128]* align 512 %9)
  call void @onebyonecpy_hls.p0a8f64.9.10([8 x double]* %10, [4 x i128]* align 512 %11)
  ret void
}

declare void @apatb_kp_502_7_hw([4 x i128]*, [4 x i128]*, [4 x i128]*, [4 x i128]*, [4 x i128]*, [4 x i128]*)

define void @kp_502_7_hw_stub_wrapper([4 x i128]*, [4 x i128]*, [4 x i128]*, [4 x i128]*, [4 x i128]*, [4 x i128]*) #5 {
entry:
  %6 = alloca [8 x double]
  %7 = alloca [8 x double]
  %8 = alloca [8 x double]
  ...
  call void @copy_out([8 x double]* %6, [4 x i128]* %0, [8 x double]* %7, [4 x i128]* %1, [8 x double]* %8, [4 x i128]* %2, [8 x double]* %9, [4 x i128]* %3, [8 x double]* %10, [4 x i128]* %4, [8 x double]* %11, [4 x i128]* %5)
  ...
  call void @copy_in([8 x double]* %6, [4 x i128]* %0, [8 x double]* %7, [4 x i128]* %1, [8 x double]* %8, [4 x i128]* %2, [8 x double]* %9, [4 x i128]* %3, [8 x double]* %10, [4 x i128]* %4, [8 x double]* %11, [4 x i128]* %5)
  ret void
}
...
!15 = !DIFile(filename: "G:/Xilinx_lab/KP_502_7/kp_502_7/sol2_4/.autopilot/db\5Ckp_502_7.pp.0.cpp", directory: "G:\5CXilinx_lab\5CKP_502_7")
!16 = !{!17, !24}
