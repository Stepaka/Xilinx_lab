...
tr.reorder();
tr.send<8>((char*)__xlx_apatb_param_X1, 8);
}
#else
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<64> > X1_pc_buffer(8);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 8; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_X1)[j*8+0] = X1_pc_buffer[i].range(7, 0).to_int64();
((char*)__xlx_apatb_param_X1)[j*8+1] = X1_pc_buffer[i].range(15, 8).to_int64();
((char*)__xlx_apatb_param_X1)[j*8+2] = X1_pc_buffer[i].range(23, 16).to_int64();
((char*)__xlx_apatb_param_X1)[j*8+3] = X1_pc_buffer[i].range(31, 24).to_int64();
((char*)__xlx_apatb_param_X1)[j*8+4] = X1_pc_buffer[i].range(39, 32).to_int64();
((char*)__xlx_apatb_param_X1)[j*8+5] = X1_pc_buffer[i].range(47, 40).to_int64();
((char*)__xlx_apatb_param_X1)[j*8+6] = X1_pc_buffer[i].range(55, 48).to_int64();
((char*)__xlx_apatb_param_X1)[j*8+7] = X1_pc_buffer[i].range(63, 56).to_int64();
}}}
        } // end transaction
      } // end file is good
...
tr.reorder();
tr.send<8>((char*)__xlx_apatb_param_X2, 8);
}
#else
{
      static ifstream rtl_tv_out_file;
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<64> > X2_pc_buffer(8);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 8; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_X2)[j*8+0] = X2_pc_buffer[i].range(7, 0).to_int64();
((char*)__xlx_apatb_param_X2)[j*8+1] = X2_pc_buffer[i].range(15, 8).to_int64();
((char*)__xlx_apatb_param_X2)[j*8+2] = X2_pc_buffer[i].range(23, 16).to_int64();
((char*)__xlx_apatb_param_X2)[j*8+3] = X2_pc_buffer[i].range(31, 24).to_int64();
((char*)__xlx_apatb_param_X2)[j*8+4] = X2_pc_buffer[i].range(39, 32).to_int64();
((char*)__xlx_apatb_param_X2)[j*8+5] = X2_pc_buffer[i].range(47, 40).to_int64();
((char*)__xlx_apatb_param_X2)[j*8+6] = X2_pc_buffer[i].range(55, 48).to_int64();
((char*)__xlx_apatb_param_X2)[j*8+7] = X2_pc_buffer[i].range(63, 56).to_int64();
}}}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
...
tr.reorder();
tr.send<8>((char*)__xlx_apatb_param_D, 8);
}
#else
{
      static ifstream rtl_tv_out_file;
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<64> > D_pc_buffer(8);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 8; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_D)[j*8+0] = D_pc_buffer[i].range(7, 0).to_int64();
((char*)__xlx_apatb_param_D)[j*8+1] = D_pc_buffer[i].range(15, 8).to_int64();
((char*)__xlx_apatb_param_D)[j*8+2] = D_pc_buffer[i].range(23, 16).to_int64();
((char*)__xlx_apatb_param_D)[j*8+3] = D_pc_buffer[i].range(31, 24).to_int64();
((char*)__xlx_apatb_param_D)[j*8+4] = D_pc_buffer[i].range(39, 32).to_int64();
((char*)__xlx_apatb_param_D)[j*8+5] = D_pc_buffer[i].range(47, 40).to_int64();
((char*)__xlx_apatb_param_D)[j*8+6] = D_pc_buffer[i].range(55, 48).to_int64();
((char*)__xlx_apatb_param_D)[j*8+7] = D_pc_buffer[i].range(63, 56).to_int64();
}}}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
...
tr.import<8>((char*)__xlx_apatb_param_A, 8, 0);
  }
tr.reorder();
...
tr.import<8>((char*)__xlx_apatb_param_B, 8, 0);
  }
tr.reorder();
...
tr.import<8>((char*)__xlx_apatb_param_C, 8, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_C, tr.p, tr.tbytes);
}

  tcl_file.set_num(8, &tcl_file.C_depth);
#else
...
transaction<64> tr(8);
  __xlx_offset_byte_param_X1 = 0*8;
  if (__xlx_apatb_param_X1) {
tr.import<8>((char*)__xlx_apatb_param_X1, 8, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_X1, tr.p, tr.tbytes);
}

  tcl_file.set_num(8, &tcl_file.X1_depth);
#else
...
aesl_fh.write(AUTOTB_TVIN_X1, begin_str(AESL_transaction));
{
  ...
  if (__xlx_apatb_param_X1) {
    for (int j = 0  - 0, e = 8 - 0; j != e; ++j) {
sc_bv<64> __xlx_tmp_lv = ((long long*)__xlx_apatb_param_X1)[j];
...
transaction<64> tr(8);
  __xlx_offset_byte_param_X2 = 0*8;
  if (__xlx_apatb_param_X2) {
tr.import<8>((char*)__xlx_apatb_param_X2, 8, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_X2, tr.p, tr.tbytes);
}

  tcl_file.set_num(8, &tcl_file.X2_depth);
#else
...
aesl_fh.write(AUTOTB_TVIN_X2, begin_str(AESL_transaction));
{
  ...
  if (__xlx_apatb_param_X2) {
    for (int j = 0  - 0, e = 8 - 0; j != e; ++j) {
sc_bv<64> __xlx_tmp_lv = ((long long*)__xlx_apatb_param_X2)[j];
...
transaction<64> tr(8);
  __xlx_offset_byte_param_D = 0*8;
  if (__xlx_apatb_param_D) {
tr.import<8>((char*)__xlx_apatb_param_D, 8, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_D, tr.p, tr.tbytes);
}

  tcl_file.set_num(8, &tcl_file.D_depth);
#else
...
aesl_fh.write(AUTOTB_TVIN_D, begin_str(AESL_transaction));
{
  ...
  if (__xlx_apatb_param_D) {
    for (int j = 0  - 0, e = 8 - 0; j != e; ++j) {
sc_bv<64> __xlx_tmp_lv = ((long long*)__xlx_apatb_param_D)[j];
