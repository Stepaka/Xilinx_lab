...
set all_solutions {sol1_2 sol2 sol2_1 sol2_2 sol2_3 sol2_4 sol2_5 sol2_6 sol2_7 sol2_8 sol2_9 sol2_10 sol2_11}
foreach the_solution $all_solutions {
  ...
  || $the_solution == "sol2_9" || $the_solution == "sol2_10"|| $the_solution == "sol2_11"} {
  ...
  if {$the_solution == "sol2_2"} {
	set_directive_unroll -factor 2 "kp_502_7/Loop"
	set_directive_array_reshape -dim 1 -factor 2 -type cyclic "kp_502_7" A
	set_directive_array_reshape -dim 1 -factor 2 -type cyclic "kp_502_7" B
	set_directive_array_reshape -dim 1 -factor 2 -type cyclic "kp_502_7" C
	set_directive_array_reshape -dim 1 -factor 2 -type cyclic "kp_502_7" X1
	set_directive_array_reshape -dim 1 -factor 2 -type cyclic "kp_502_7" X2
	set_directive_array_reshape -dim 1 -factor 2 -type cyclic "kp_502_7" D
  }
