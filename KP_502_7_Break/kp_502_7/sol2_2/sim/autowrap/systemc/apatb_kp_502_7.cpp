...
tr.reorder();
tr.send<4>((char*)__xlx_apatb_param_X1_0, 4);
}
#else
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > X1_0_pc_buffer(4);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 4; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_X1_0)[j*4+0] = X1_0_pc_buffer[i].range(7, 0).to_int64();
...
tr.reorder();
tr.send<4>((char*)__xlx_apatb_param_X1_1, 4);
}
#else
{
      static ifstream rtl_tv_out_file;
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > X1_1_pc_buffer(4);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 4; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_X1_1)[j*4+0] = X1_1_pc_buffer[i].range(7, 0).to_int64();
...
tr.reorder();
tr.send<4>((char*)__xlx_apatb_param_X2_0, 4);
}
#else
{
      static ifstream rtl_tv_out_file;
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > X2_0_pc_buffer(4);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 4; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_X2_0)[j*4+0] = X2_0_pc_buffer[i].range(7, 0).to_int64();
...
tr.reorder();
tr.send<4>((char*)__xlx_apatb_param_X2_1, 4);
}
#else
{
      static ifstream rtl_tv_out_file;
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > X2_1_pc_buffer(4);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 4; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_X2_1)[j*4+0] = X2_1_pc_buffer[i].range(7, 0).to_int64();
...
tr.reorder();
tr.send<4>((char*)__xlx_apatb_param_D_0, 4);
}
#else
{
      static ifstream rtl_tv_out_file;
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > D_0_pc_buffer(4);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 4; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_D_0)[j*4+0] = D_0_pc_buffer[i].range(7, 0).to_int64();
...
tr.reorder();
tr.send<4>((char*)__xlx_apatb_param_D_1, 4);
}
#else
{
      static ifstream rtl_tv_out_file;
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > D_1_pc_buffer(4);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 4; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_D_1)[j*4+0] = D_1_pc_buffer[i].range(7, 0).to_int64();
...
tr.import<4>((char*)__xlx_apatb_param_A_0, 4, 0);
  }
tr.reorder();
...
tr.import<4>((char*)__xlx_apatb_param_A_1, 4, 0);
  }
tr.reorder();
...
tr.import<4>((char*)__xlx_apatb_param_B_0, 4, 0);
  }
tr.reorder();
...
tr.import<4>((char*)__xlx_apatb_param_B_1, 4, 0);
  }
tr.reorder();
...
tr.import<4>((char*)__xlx_apatb_param_C_0, 4, 0);
  }
tr.reorder();
...
tr.import<4>((char*)__xlx_apatb_param_C_1, 4, 0);
  }
tr.reorder();
...
tr.import<4>((char*)__xlx_apatb_param_X1_0, 4, 0);
  }
tr.reorder();
...
tr.import<4>((char*)__xlx_apatb_param_X1_1, 4, 0);
  }
tr.reorder();
...
tr.import<4>((char*)__xlx_apatb_param_X2_0, 4, 0);
  }
tr.reorder();
...
tr.import<4>((char*)__xlx_apatb_param_X2_1, 4, 0);
  }
tr.reorder();
...
tr.import<4>((char*)__xlx_apatb_param_D_0, 4, 0);
  }
tr.reorder();
...
tr.import<4>((char*)__xlx_apatb_param_D_1, 4, 0);
  }
tr.reorder();
