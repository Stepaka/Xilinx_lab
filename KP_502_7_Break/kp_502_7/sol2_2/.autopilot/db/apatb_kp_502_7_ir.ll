...
define internal void @onebyonecpy_hls.p0a8i32.76.77([4 x i32]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, [4 x i32]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, [8 x i32]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
entry:
  call void @onebyonecpy_hls.p0a8i32.76.77([4 x i32]* align 512 %_0, [4 x i32]* align 512 %_1, [8 x i32]* %0)
  call void @onebyonecpy_hls.p0a8i32.76.77([4 x i32]* align 512 %_01, [4 x i32]* align 512 %_12, [8 x i32]* %1)
  call void @onebyonecpy_hls.p0a8i32.76.77([4 x i32]* align 512 %_03, [4 x i32]* align 512 %_14, [8 x i32]* %2)
  call void @onebyonecpy_hls.p0a8i32.76.77([4 x i32]* align 512 %_05, [4 x i32]* align 512 %_16, [8 x i32]* %3)
  call void @onebyonecpy_hls.p0a8i32.76.77([4 x i32]* align 512 %_07, [4 x i32]* align 512 %_18, [8 x i32]* %4)
  call void @onebyonecpy_hls.p0a8i32.76.77([4 x i32]* align 512 %_09, [4 x i32]* align 512 %_110, [8 x i32]* %5)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a8i32.82.83([8 x i32]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [4 x i32]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [4 x i32]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #3 {
entry:
...
entry:
  call void @onebyonecpy_hls.p0a8i32.82.83([8 x i32]* %0, [4 x i32]* align 512 %_0, [4 x i32]* align 512 %_1)
  call void @onebyonecpy_hls.p0a8i32.82.83([8 x i32]* %1, [4 x i32]* align 512 %_01, [4 x i32]* align 512 %_12)
  call void @onebyonecpy_hls.p0a8i32.82.83([8 x i32]* %2, [4 x i32]* align 512 %_03, [4 x i32]* align 512 %_14)
  call void @onebyonecpy_hls.p0a8i32.82.83([8 x i32]* %3, [4 x i32]* align 512 %_05, [4 x i32]* align 512 %_16)
  call void @onebyonecpy_hls.p0a8i32.82.83([8 x i32]* %4, [4 x i32]* align 512 %_07, [4 x i32]* align 512 %_18)
  call void @onebyonecpy_hls.p0a8i32.82.83([8 x i32]* %5, [4 x i32]* align 512 %_09, [4 x i32]* align 512 %_110)
  ret void
}
