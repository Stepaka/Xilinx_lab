...
entry:
  ...
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %B_copy.gep8, i32 0, i32 1, i32 0) ], !dbg !356
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %C_copy.gep9, i32 0, i32 1, i32 0) ], !dbg !356
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %X1_copy.gep10, i32 0, i32 1, i32 0) ], !dbg !356
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %X2_copy.gep11, i32 0, i32 1, i32 0) ], !dbg !356
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %D_copy.gep12, i32 0, i32 1, i32 0) ], !dbg !356
...
define internal void @onebyonecpy_hls.p0a8i32.76.77([2 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [8 x i32]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
entry:
  call void @onebyonecpy_hls.p0a8i32.76.77([2 x i128]* align 512 %1, [8 x i32]* %0)
  call void @onebyonecpy_hls.p0a8i32.76.77([2 x i128]* align 512 %3, [8 x i32]* %2)
  call void @onebyonecpy_hls.p0a8i32.76.77([2 x i128]* align 512 %5, [8 x i32]* %4)
  call void @onebyonecpy_hls.p0a8i32.76.77([2 x i128]* align 512 %7, [8 x i32]* %6)
  call void @onebyonecpy_hls.p0a8i32.76.77([2 x i128]* align 512 %9, [8 x i32]* %8)
  call void @onebyonecpy_hls.p0a8i32.76.77([2 x i128]* align 512 %11, [8 x i32]* %10)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a8i32.82.83([8 x i32]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [2 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
entry:
  call void @onebyonecpy_hls.p0a8i32.82.83([8 x i32]* %0, [2 x i128]* align 512 %1)
  call void @onebyonecpy_hls.p0a8i32.82.83([8 x i32]* %2, [2 x i128]* align 512 %3)
  call void @onebyonecpy_hls.p0a8i32.82.83([8 x i32]* %4, [2 x i128]* align 512 %5)
  call void @onebyonecpy_hls.p0a8i32.82.83([8 x i32]* %6, [2 x i128]* align 512 %7)
  call void @onebyonecpy_hls.p0a8i32.82.83([8 x i32]* %8, [2 x i128]* align 512 %9)
  call void @onebyonecpy_hls.p0a8i32.82.83([8 x i32]* %10, [2 x i128]* align 512 %11)
  ret void
}
