...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename C \
    op interface \
    ports { C_address0 { O 3 vector } C_ce0 { O 1 bit } C_q0 { I 32 vector } C_address1 { O 3 vector } C_ce1 { O 1 bit } C_q1 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename X1 \
    op interface \
    ports { X1_address0 { O 3 vector } X1_ce0 { O 1 bit } X1_we0 { O 1 bit } X1_d0 { O 32 vector } X1_address1 { O 3 vector } X1_ce1 { O 1 bit } X1_we1 { O 1 bit } X1_d1 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename X2 \
    op interface \
    ports { X2_address0 { O 3 vector } X2_ce0 { O 1 bit } X2_we0 { O 1 bit } X2_d0 { O 32 vector } X2_address1 { O 3 vector } X2_ce1 { O 1 bit } X2_we1 { O 1 bit } X2_d1 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename D \
    op interface \
    ports { D_address0 { O 3 vector } D_ce0 { O 1 bit } D_we0 { O 1 bit } D_d0 { O 32 vector } D_address1 { O 3 vector } D_ce1 { O 1 bit } D_we1 { O 1 bit } D_d1 { O 32 vector } } \
} "
} else {
