...
set C_modelArgList {
	...
	{ X1 int 64 regular {array 8 { 3 0 } 0 1 }  }
	{ X2 int 64 regular {array 8 { 3 0 } 0 1 }  }
	{ D int 64 regular {array 8 { 3 0 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7"],
		...
		"Loop" : [
			{"Name" : "Loop", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "85", "FirstState" : "ap_ST_fsm_state2", "LastState" : ["ap_ST_fsm_state85"], "QuitState" : ["ap_ST_fsm_state2"], "PreState" : ["ap_ST_fsm_state1"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
	...
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dsqrt_64ns_64ns_64_30_no_dsp_1_U7", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	X1 { ap_memory {  { X1_address1 MemPortADDR2 1 3 }  { X1_ce1 MemPortCE2 1 1 }  { X1_we1 MemPortWE2 1 1 }  { X1_d1 MemPortDIN2 1 64 } } }
	X2 { ap_memory {  { X2_address1 MemPortADDR2 1 3 }  { X2_ce1 MemPortCE2 1 1 }  { X2_we1 MemPortWE2 1 1 }  { X2_d1 MemPortDIN2 1 64 } } }
	D { ap_memory {  { D_address1 MemPortADDR2 1 3 }  { D_ce1 MemPortCE2 1 1 }  { D_we1 MemPortWE2 1 1 }  { D_d1 MemPortDIN2 1 64 } } }
}
