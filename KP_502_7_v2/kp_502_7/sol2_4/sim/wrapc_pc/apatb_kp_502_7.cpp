...
tr.reorder();
tr.send<32>((char*)__xlx_apatb_param_X1, 2);
}
#else
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<256> > X1_pc_buffer(2);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 2; j < e; j += 1, ++i) {((long long*)__xlx_apatb_param_X1)[j*4+0] = X1_pc_buffer[i].range(63,0).to_int64();
((long long*)__xlx_apatb_param_X1)[j*4+1] = X1_pc_buffer[i].range(127,64).to_int64();
((long long*)__xlx_apatb_param_X1)[j*4+2] = X1_pc_buffer[i].range(191,128).to_int64();
((long long*)__xlx_apatb_param_X1)[j*4+3] = X1_pc_buffer[i].range(255,192).to_int64();
}}}
        } // end transaction
      } // end file is good
...
tr.reorder();
tr.send<32>((char*)__xlx_apatb_param_X2, 2);
}
#else
{
      static ifstream rtl_tv_out_file;
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<256> > X2_pc_buffer(2);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 2; j < e; j += 1, ++i) {((long long*)__xlx_apatb_param_X2)[j*4+0] = X2_pc_buffer[i].range(63,0).to_int64();
((long long*)__xlx_apatb_param_X2)[j*4+1] = X2_pc_buffer[i].range(127,64).to_int64();
((long long*)__xlx_apatb_param_X2)[j*4+2] = X2_pc_buffer[i].range(191,128).to_int64();
((long long*)__xlx_apatb_param_X2)[j*4+3] = X2_pc_buffer[i].range(255,192).to_int64();
}}}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
...
tr.reorder();
tr.send<32>((char*)__xlx_apatb_param_D, 2);
}
#else
{
      static ifstream rtl_tv_out_file;
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<256> > D_pc_buffer(2);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 2; j < e; j += 1, ++i) {((long long*)__xlx_apatb_param_D)[j*4+0] = D_pc_buffer[i].range(63,0).to_int64();
((long long*)__xlx_apatb_param_D)[j*4+1] = D_pc_buffer[i].range(127,64).to_int64();
((long long*)__xlx_apatb_param_D)[j*4+2] = D_pc_buffer[i].range(191,128).to_int64();
((long long*)__xlx_apatb_param_D)[j*4+3] = D_pc_buffer[i].range(255,192).to_int64();
}}}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
...
transaction<256> tr(2);
  __xlx_offset_byte_param_X1 = 0*32;
  if (__xlx_apatb_param_X1) {
tr.import<32>((char*)__xlx_apatb_param_X1, 2, 0);
  }
tr.reorder();
...
aesl_fh.write(AUTOTB_TVIN_X1, begin_str(AESL_transaction));
{
  ...
  if (__xlx_apatb_param_X1) {
    for (int j = 0  - 0, e = 2 - 0; j != e; ++j) {
sc_bv<256> __xlx_tmp_lv;
__xlx_tmp_lv.range(63,0) = ((long long*)__xlx_apatb_param_X1)[j*4+0];
__xlx_tmp_lv.range(127,64) = ((long long*)__xlx_apatb_param_X1)[j*4+1];
__xlx_tmp_lv.range(191,128) = ((long long*)__xlx_apatb_param_X1)[j*4+2];
__xlx_tmp_lv.range(255,192) = ((long long*)__xlx_apatb_param_X1)[j*4+3];
...
transaction<256> tr(2);
  __xlx_offset_byte_param_X2 = 0*32;
  if (__xlx_apatb_param_X2) {
tr.import<32>((char*)__xlx_apatb_param_X2, 2, 0);
  }
tr.reorder();
...
aesl_fh.write(AUTOTB_TVIN_X2, begin_str(AESL_transaction));
{
  ...
  if (__xlx_apatb_param_X2) {
    for (int j = 0  - 0, e = 2 - 0; j != e; ++j) {
sc_bv<256> __xlx_tmp_lv;
__xlx_tmp_lv.range(63,0) = ((long long*)__xlx_apatb_param_X2)[j*4+0];
__xlx_tmp_lv.range(127,64) = ((long long*)__xlx_apatb_param_X2)[j*4+1];
__xlx_tmp_lv.range(191,128) = ((long long*)__xlx_apatb_param_X2)[j*4+2];
__xlx_tmp_lv.range(255,192) = ((long long*)__xlx_apatb_param_X2)[j*4+3];
...
transaction<256> tr(2);
  __xlx_offset_byte_param_D = 0*32;
  if (__xlx_apatb_param_D) {
tr.import<32>((char*)__xlx_apatb_param_D, 2, 0);
  }
tr.reorder();
...
aesl_fh.write(AUTOTB_TVIN_D, begin_str(AESL_transaction));
{
  ...
  if (__xlx_apatb_param_D) {
    for (int j = 0  - 0, e = 2 - 0; j != e; ++j) {
sc_bv<256> __xlx_tmp_lv;
__xlx_tmp_lv.range(63,0) = ((long long*)__xlx_apatb_param_D)[j*4+0];
__xlx_tmp_lv.range(127,64) = ((long long*)__xlx_apatb_param_D)[j*4+1];
__xlx_tmp_lv.range(191,128) = ((long long*)__xlx_apatb_param_D)[j*4+2];
__xlx_tmp_lv.range(255,192) = ((long long*)__xlx_apatb_param_D)[j*4+3];
