...
set C_modelArgList {
	...
	{ X1 int 256 regular {array 2 { 0 3 } 0 1 }  }
	{ X2 int 256 regular {array 2 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "memory", "bitwidth" : 256, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "X1", "interface" : "memory", "bitwidth" : 256, "direction" : "WRITEONLY"} , 
 	{ "Name" : "X2", "interface" : "memory", "bitwidth" : 256, "direction" : "WRITEONLY"} , 
...
set Spec2ImplPortList { 
	...
	X1 { ap_memory {  { X1_address0 mem_address 1 1 }  { X1_ce0 mem_ce 1 1 }  { X1_we0 mem_we 1 1 }  { X1_d0 mem_din 1 256 } } }
	X2 { ap_memory {  { X2_address0 mem_address 1 1 }  { X2_ce0 mem_ce 1 1 }  { X2_we0 mem_we 1 1 }  { X2_d0 mem_din 1 256 } } }
