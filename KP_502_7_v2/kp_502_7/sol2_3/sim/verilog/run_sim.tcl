...
if {[file isfile kp_502_7.autotvin.dat]} {
	file delete -force kp_502_7.autotvin.dat
}

if {[file isfile kp_502_7.autotvout.dat]} {
	file delete -force kp_502_7.autotvout.dat
}
