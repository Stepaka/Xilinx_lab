...
# ==============================================================
set ::env(PATH) "$::env(PATH);G:/Xilinx/Vitis_HLS/2021.2/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);G:/Xilinx/Vitis_HLS/2021.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);G:/Xilinx/Vitis_HLS/2021.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);G:/Xilinx/Vitis_HLS/2021.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "kp_502_7.autotvin.dat"
	set constFileTvOut       "kp_502_7.autotvout.dat"
	set constFileHdlTvIn     "kp_502_7.autohdltvin.dat"
	set constFileHdlTvOut    "kp_502_7.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
