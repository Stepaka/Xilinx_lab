...
set C_modelArgList {
	...
	{ C int 64 regular {array 8 { 1 1 } 1 1 }  }
	{ X1 int 64 regular {array 8 { 0 0 } 0 1 }  }
	{ X2 int 64 regular {array 8 { 0 0 } 0 1 }  }
	{ D int 64 regular {array 8 { 0 0 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "X1", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "X2", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "D", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_local_block", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ap_local_block", "role": "default" }} , 
 	...
 	{ "name": "X1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "X1", "role": "d0" }} , 
 	...
 	{ "name": "X1_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "X1", "role": "d1" }} , 
 	...
 	{ "name": "D_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "D", "role": "d1" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ddiv_64ns_64ns_64_31_no_dsp_1_U9", "Parent" : "0"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ddiv_64ns_64ns_64_31_no_dsp_1_U10", "Parent" : "0"},
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ddiv_64ns_64ns_64_31_no_dsp_1_U11", "Parent" : "0"},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ddiv_64ns_64ns_64_31_no_dsp_1_U12", "Parent" : "0"},
	{"ID" : "13", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dsqrt_64ns_64ns_64_30_no_dsp_1_U13", "Parent" : "0"},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dsqrt_64ns_64ns_64_30_no_dsp_1_U14", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	kp_502_7 {
		...
		X1 {Type O LastRead -1 FirstWrite 83}
		X2 {Type O LastRead -1 FirstWrite 83}
...
set Spec2ImplPortList { 
	...
	C { ap_memory {  { C_address0 mem_address 1 3 }  { C_ce0 mem_ce 1 1 }  { C_q0 mem_dout 0 64 }  { C_address1 MemPortADDR2 1 3 }  { C_ce1 MemPortCE2 1 1 }  { C_q1 MemPortDOUT2 0 64 } } }
	X1 { ap_memory {  { X1_address0 mem_address 1 3 }  { X1_ce0 mem_ce 1 1 }  { X1_we0 mem_we 1 1 }  { X1_d0 mem_din 1 64 }  { X1_address1 MemPortADDR2 1 3 }  { X1_ce1 MemPortCE2 1 1 }  { X1_we1 MemPortWE2 1 1 }  { X1_d1 MemPortDIN2 1 64 } } }
	X2 { ap_memory {  { X2_address0 mem_address 1 3 }  { X2_ce0 mem_ce 1 1 }  { X2_we0 mem_we 1 1 }  { X2_d0 mem_din 1 64 }  { X2_address1 MemPortADDR2 1 3 }  { X2_ce1 MemPortCE2 1 1 }  { X2_we1 MemPortWE2 1 1 }  { X2_d1 MemPortDIN2 1 64 } } }
	D { ap_memory {  { D_address0 mem_address 1 3 }  { D_ce0 mem_ce 1 1 }  { D_we0 mem_we 1 1 }  { D_d0 mem_din 1 64 }  { D_address1 MemPortADDR2 1 3 }  { D_ce1 MemPortCE2 1 1 }  { D_we1 MemPortWE2 1 1 }  { D_d1 MemPortDIN2 1 64 } } }
}
