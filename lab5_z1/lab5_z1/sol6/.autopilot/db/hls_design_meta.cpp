...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("d_in_address0", 8, hls_out, 0, "ap_memory", "mem_address", 1),
	Port_Property("d_in_ce0", 1, hls_out, 0, "ap_memory", "mem_ce", 1),
	Port_Property("d_in_q0", 32, hls_in, 0, "ap_memory", "in_data", 1),
	Port_Property("d_in_address1", 8, hls_out, 0, "ap_memory", "MemPortADDR2", 1),
	Port_Property("d_in_ce1", 1, hls_out, 0, "ap_memory", "MemPortCE2", 1),
	Port_Property("d_in_q1", 32, hls_in, 0, "ap_memory", "in_data", 1),
