...
set C_modelArgList {
	{ d_in int 32 regular {array 256 { 1 1 } 1 1 }  }
	{ d_out int 16 regular {array 128 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "d_in", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ d_in_address0 sc_out sc_lv 8 signal 0 } 
	{ d_in_ce0 sc_out sc_logic 1 signal 0 } 
	{ d_in_q0 sc_in sc_lv 32 signal 0 } 
	{ d_in_address1 sc_out sc_lv 8 signal 0 } 
	{ d_in_ce1 sc_out sc_logic 1 signal 0 } 
	{ d_in_q1 sc_in sc_lv 32 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_local_block", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ap_local_block", "role": "default" }} , 
 	...
 	{ "name": "d_in_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "d_in", "role": "address0" }} , 
 	...
 	{ "name": "d_in_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "d_in", "role": "address1" }} , 
 	{ "name": "d_in_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "d_in", "role": "ce1" }} , 
 	{ "name": "d_in_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "d_in", "role": "q1" }} , 
...
set ArgLastReadFirstWriteLatency {
	lab5_z1 {
		d_in {Type I LastRead 2 FirstWrite -1}
...
set Spec2ImplPortList { 
	d_in { ap_memory {  { d_in_address0 mem_address 1 8 }  { d_in_ce0 mem_ce 1 1 }  { d_in_q0 in_data 0 32 }  { d_in_address1 MemPortADDR2 1 8 }  { d_in_ce1 MemPortCE2 1 1 }  { d_in_q1 in_data 0 32 } } }
