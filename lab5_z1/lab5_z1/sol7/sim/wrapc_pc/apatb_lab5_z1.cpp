...
tr.import<2>((char*)__xlx_apatb_param_d_in_0, 128, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_d_in_0, tr.p, tr.tbytes);
}

  tcl_file.set_num(128, &tcl_file.d_in_0_depth);
#else
...
tr.import<2>((char*)__xlx_apatb_param_d_in_1, 128, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_d_in_1, tr.p, tr.tbytes);
}

  tcl_file.set_num(128, &tcl_file.d_in_1_depth);
#else
...
tr.import<2>((char*)__xlx_apatb_param_d_in_2, 128, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_d_in_2, tr.p, tr.tbytes);
}

  tcl_file.set_num(128, &tcl_file.d_in_2_depth);
#else
...
tr.import<2>((char*)__xlx_apatb_param_d_in_3, 128, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_d_in_3, tr.p, tr.tbytes);
}

  tcl_file.set_num(128, &tcl_file.d_in_3_depth);
#else
