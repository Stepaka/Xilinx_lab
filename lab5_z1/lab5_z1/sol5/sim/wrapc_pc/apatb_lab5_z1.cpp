...
static bool RTLOutputCheckAndReplacement(std::string &AESL_token, std::string PortName) {
  ...
  return err;}
extern "C" void lab5_z1_hw_stub_wrapper(volatile void *, volatile void *, volatile void *);

extern "C" void apatb_lab5_z1_hw(volatile void * __xlx_apatb_param_d_in_0, volatile void * __xlx_apatb_param_d_in_1, volatile void * __xlx_apatb_param_d_out) {
...
tr.import<2>((char*)__xlx_apatb_param_d_in_0, 256, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_d_in_0, tr.p, tr.tbytes);
}

  tcl_file.set_num(256, &tcl_file.d_in_0_depth);
#else
...
tr.import<2>((char*)__xlx_apatb_param_d_in_1, 256, 0);
  }
tr.reorder();
aesl_fh.write(AUTOTB_TVIN_d_in_1, tr.p, tr.tbytes);
}

  tcl_file.set_num(256, &tcl_file.d_in_1_depth);
#else
...
lab5_z1_hw_stub_wrapper(__xlx_apatb_param_d_in_0, __xlx_apatb_param_d_in_1, __xlx_apatb_param_d_out);
