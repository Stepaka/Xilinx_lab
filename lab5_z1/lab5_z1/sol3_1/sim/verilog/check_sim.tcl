...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.lab5_z1.autotvin_d_in_0.dat"
         "c.lab5_z1.autotvin_d_in_1.dat"
         "c.lab5_z1.autotvin_d_in_2.dat"
         "c.lab5_z1.autotvin_d_in_3.dat"
         "c.lab5_z1.autotvin_d_out.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.lab5_z1.autotvout_d_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
