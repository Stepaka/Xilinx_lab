...
(* CORE_GENERATION_INFO="lab5_z1_lab5_z1,hls_ip_2021_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xa7a12t-csg325-1Q,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=12.697000,HLS_SYN_LAT=130,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=19,HLS_SYN_LUT=121,HLS_VERSION=2021_2}" *)
...
reg   [7:0] i_fu_54;
wire   [7:0] add_ln6_fu_137_p2;
wire    ap_loop_init;
reg   [7:0] ap_sig_allocacmp_i_1;
wire   [6:0] trunc_ln6_fu_148_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_110)) begin
        if ((icmp_ln6_fu_131_p2 == 1'd0)) begin
            i_fu_54 <= add_ln6_fu_137_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln6_fu_131_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        zext_ln6_reg_193[7 : 0] <= zext_ln6_fu_143_p1[7 : 0];
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln6_fu_131_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
assign add_ln11_1_fu_170_p2 = (d_in_2_q0 + d_in_3_q0);

assign add_ln11_fu_164_p2 = (d_in_1_q0 + d_in_0_q0);

assign add_ln6_fu_137_p2 = (ap_sig_allocacmp_i_1 + 8'd1);
...
assign d_in_0_address0 = zext_ln6_fu_143_p1;

assign d_in_1_address0 = zext_ln8_fu_152_p1;

assign d_in_2_address0 = zext_ln8_fu_152_p1;

assign d_in_3_address0 = zext_ln8_fu_152_p1;

assign d_out_address0 = zext_ln6_reg_193;

assign d_out_d0 = (add_ln11_1_fu_170_p2 + add_ln11_fu_164_p2);

assign icmp_ln6_fu_131_p2 = ((ap_sig_allocacmp_i_1 == 8'd128) ? 1'b1 : 1'b0);

assign trunc_ln6_fu_148_p1 = ap_sig_allocacmp_i_1[6:0];

assign zext_ln6_fu_143_p1 = ap_sig_allocacmp_i_1;

assign zext_ln8_fu_152_p1 = trunc_ln6_fu_148_p1;
