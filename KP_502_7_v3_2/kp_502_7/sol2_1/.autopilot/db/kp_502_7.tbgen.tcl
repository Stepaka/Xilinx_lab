...
set C_modelArgList {
	...
	{ X1 int 32 regular {array 8 { 3 0 } 0 1 }  }
	{ X2 int 32 regular {array 8 { 3 0 } 0 1 }  }
	{ D int 32 regular {array 8 { 3 0 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_sqrt_fixed_32_32_s_fu_274", "Parent" : "0",
	...
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sdiv_32s_32ns_32_36_seq_1_U7", "Parent" : "0"},
...
set ArgLastReadFirstWriteLatency {
	kp_502_7 {
		A {Type I LastRead 56 FirstWrite -1}
		B {Type I LastRead 56 FirstWrite -1}
		C {Type I LastRead 56 FirstWrite -1}
		X1 {Type O LastRead -1 FirstWrite 6}
		X2 {Type O LastRead -1 FirstWrite 6}
...
set Spec2ImplPortList { 
	...
	B { ap_memory {  { B_address0 mem_address 1 3 }  { B_ce0 mem_ce 1 1 }  { B_q0 mem_dout 0 32 } } }
	C { ap_memory {  { C_address0 mem_address 1 3 }  { C_ce0 mem_ce 1 1 }  { C_q0 mem_dout 0 32 } } }
	X1 { ap_memory {  { X1_address1 MemPortADDR2 1 3 }  { X1_ce1 MemPortCE2 1 1 }  { X1_we1 MemPortWE2 1 1 }  { X1_d1 MemPortDIN2 1 32 } } }
	X2 { ap_memory {  { X2_address1 MemPortADDR2 1 3 }  { X2_ce1 MemPortCE2 1 1 }  { X2_we1 MemPortWE2 1 1 }  { X2_d1 MemPortDIN2 1 32 } } }
	D { ap_memory {  { D_address1 MemPortADDR2 1 3 }  { D_ce1 MemPortCE2 1 1 }  { D_we1 MemPortWE2 1 1 }  { D_d1 MemPortDIN2 1 32 } } }
}
