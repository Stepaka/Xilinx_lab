; ModuleID = 'G:/Xilinx_lab/KP_502_7_v3_2/kp_502_7/sol2_5/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  call void @onebyonecpy_hls.p0a8i32.15.16(i32* align 512 %_0, i32* align 512 %_1, i32* align 512 %_2, i32* align 512 %_3, i32* align 512 %_4, i32* align 512 %_5, i32* align 512 %_6, i32* align 512 %_7, [8 x i32]* %0)
  call void @onebyonecpy_hls.p0a8i32.15.16(i32* align 512 %_01, i32* align 512 %_12, i32* align 512 %_23, i32* align 512 %_34, i32* align 512 %_45, i32* align 512 %_56, i32* align 512 %_67, i32* align 512 %_78, [8 x i32]* %1)
  call void @onebyonecpy_hls.p0a8i32.15.16(i32* align 512 %_09, i32* align 512 %_110, i32* align 512 %_211, i32* align 512 %_312, i32* align 512 %_413, i32* align 512 %_514, i32* align 512 %_615, i32* align 512 %_716, [8 x i32]* %2)
  call void @onebyonecpy_hls.p0a8i32.15.16(i32* align 512 %_017, i32* align 512 %_118, i32* align 512 %_219, i32* align 512 %_320, i32* align 512 %_421, i32* align 512 %_522, i32* align 512 %_623, i32* align 512 %_724, [8 x i32]* %3)
  call void @onebyonecpy_hls.p0a8i32.15.16(i32* align 512 %_025, i32* align 512 %_126, i32* align 512 %_227, i32* align 512 %_328, i32* align 512 %_429, i32* align 512 %_530, i32* align 512 %_631, i32* align 512 %_732, [8 x i32]* %4)
  call void @onebyonecpy_hls.p0a8i32.15.16(i32* align 512 %_033, i32* align 512 %_134, i32* align 512 %_235, i32* align 512 %_336, i32* align 512 %_437, i32* align 512 %_538, i32* align 512 %_639, i32* align 512 %_740, [8 x i32]* %5)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a8i32.21.22([8 x i32]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", i32* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, i32* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, i32* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_2, i32* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_3, i32* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_4, i32* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_5, i32* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_6, i32* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_7) #1 {
entry:
...
entry:
  call void @onebyonecpy_hls.p0a8i32.21.22([8 x i32]* %0, i32* align 512 %_0, i32* align 512 %_1, i32* align 512 %_2, i32* align 512 %_3, i32* align 512 %_4, i32* align 512 %_5, i32* align 512 %_6, i32* align 512 %_7)
  call void @onebyonecpy_hls.p0a8i32.21.22([8 x i32]* %1, i32* align 512 %_01, i32* align 512 %_12, i32* align 512 %_23, i32* align 512 %_34, i32* align 512 %_45, i32* align 512 %_56, i32* align 512 %_67, i32* align 512 %_78)
  call void @onebyonecpy_hls.p0a8i32.21.22([8 x i32]* %2, i32* align 512 %_09, i32* align 512 %_110, i32* align 512 %_211, i32* align 512 %_312, i32* align 512 %_413, i32* align 512 %_514, i32* align 512 %_615, i32* align 512 %_716)
  call void @onebyonecpy_hls.p0a8i32.21.22([8 x i32]* %3, i32* align 512 %_017, i32* align 512 %_118, i32* align 512 %_219, i32* align 512 %_320, i32* align 512 %_421, i32* align 512 %_522, i32* align 512 %_623, i32* align 512 %_724)
  call void @onebyonecpy_hls.p0a8i32.21.22([8 x i32]* %4, i32* align 512 %_025, i32* align 512 %_126, i32* align 512 %_227, i32* align 512 %_328, i32* align 512 %_429, i32* align 512 %_530, i32* align 512 %_631, i32* align 512 %_732)
  call void @onebyonecpy_hls.p0a8i32.21.22([8 x i32]* %5, i32* align 512 %_033, i32* align 512 %_134, i32* align 512 %_235, i32* align 512 %_336, i32* align 512 %_437, i32* align 512 %_538, i32* align 512 %_639, i32* align 512 %_740)
  ret void
}
