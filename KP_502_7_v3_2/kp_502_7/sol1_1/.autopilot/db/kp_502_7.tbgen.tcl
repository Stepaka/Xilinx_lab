...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "33", "EstimateLatencyMax" : "369",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Loop" : [
			{"Name" : "Loop", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "82", "FirstState" : "ap_ST_fsm_state2", "LastState" : ["ap_ST_fsm_state47"], "QuitState" : ["ap_ST_fsm_state2"], "PreState" : ["ap_ST_fsm_state1"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
...
set ArgLastReadFirstWriteLatency {
	kp_502_7 {
		...
		X1 {Type O LastRead -1 FirstWrite 3}
		X2 {Type O LastRead -1 FirstWrite 3}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "33", "Max" : "369"}
	, {"Name" : "Interval", "Min" : "34", "Max" : "370"}
]}
