...
module kp_502_7_p_hls_fptosi_double_i64 (
        ap_ready,
        x,
        ap_return
);
...
wire   [51:0] tmp_71_fu_66_p1;
wire   [53:0] mantissa_fu_70_p4;
wire   [10:0] tmp_70_fu_56_p4;
...
wire   [168:0] zext_ln15_fu_80_p1;
wire   [168:0] zext_ln1340_fu_124_p1;
wire   [168:0] r_V_fu_128_p2;
wire   [0:0] tmp_fu_140_p3;
wire   [168:0] r_V_1_fu_134_p2;
wire   [63:0] zext_ln671_fu_148_p1;
wire   [63:0] tmp_s_fu_152_p4;
wire   [63:0] val_fu_162_p3;
wire   [0:0] p_Result_s_fu_48_p3;
wire   [63:0] result_V_2_fu_170_p2;
...
assign mantissa_fu_70_p4 = {{{{1'd1}, {tmp_71_fu_66_p1}}}, {1'd0}};
...
assign result_V_2_fu_170_p2 = (64'd0 - val_fu_162_p3);

assign sext_ln1340_fu_120_p1 = $signed(ush_fu_112_p3);

assign sext_ln1364_fu_108_p1 = $signed(sub_ln1364_fu_102_p2);

assign sub_ln1364_fu_102_p2 = (11'd1023 - tmp_70_fu_56_p4);

assign tmp_70_fu_56_p4 = {{data_V_fu_44_p1[62:52]}};

assign tmp_71_fu_66_p1 = data_V_fu_44_p1[51:0];

assign tmp_fu_140_p3 = r_V_fu_128_p2[32'd53];

assign tmp_s_fu_152_p4 = {{r_V_1_fu_134_p2[116:53]}};
...
assign zext_ln513_fu_84_p1 = tmp_70_fu_56_p4;

assign zext_ln671_fu_148_p1 = tmp_fu_140_p3;

endmodule //kp_502_7_p_hls_fptosi_double_i64
