; ModuleID = 'G:/Xilinx_lab/KP_502_7_v3_2/kp_502_7/sol2_4/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  %A_copy1 = alloca [2 x i128], align 512
  %B_copy2 = alloca [2 x i128], align 512
  %C_copy3 = alloca [2 x i128], align 512
  %X1_copy4 = alloca [2 x i128], align 512
  %X2_copy5 = alloca [2 x i128], align 512
  %D_copy6 = alloca [2 x i128], align 512
  ...
  call void @copy_in([8 x i32]* %0, [2 x i128]* nonnull align 512 %A_copy1, [8 x i32]* %1, [2 x i128]* nonnull align 512 %B_copy2, [8 x i32]* %2, [2 x i128]* nonnull align 512 %C_copy3, [8 x i32]* %3, [2 x i128]* nonnull align 512 %X1_copy4, [8 x i32]* %4, [2 x i128]* nonnull align 512 %X2_copy5, [8 x i32]* %5, [2 x i128]* nonnull align 512 %D_copy6)
  %A_copy.gep7 = getelementptr [2 x i128], [2 x i128]* %A_copy1, i64 0, i32 0
  %B_copy.gep8 = getelementptr [2 x i128], [2 x i128]* %B_copy2, i64 0, i32 0
  %C_copy.gep9 = getelementptr [2 x i128], [2 x i128]* %C_copy3, i64 0, i32 0
  %X1_copy.gep10 = getelementptr [2 x i128], [2 x i128]* %X1_copy4, i64 0, i32 0
  %X2_copy.gep11 = getelementptr [2 x i128], [2 x i128]* %X2_copy5, i64 0, i32 0
  %D_copy.gep12 = getelementptr [2 x i128], [2 x i128]* %D_copy6, i64 0, i32 0
  ...
  call void @apatb_kp_502_7_hw([2 x i128]* %A_copy1, [2 x i128]* %B_copy2, [2 x i128]* %C_copy3, [2 x i128]* %X1_copy4, [2 x i128]* %X2_copy5, [2 x i128]* %D_copy6)
  call void @copy_out([8 x i32]* %0, [2 x i128]* nonnull align 512 %A_copy1, [8 x i32]* %1, [2 x i128]* nonnull align 512 %B_copy2, [8 x i32]* %2, [2 x i128]* nonnull align 512 %C_copy3, [8 x i32]* %3, [2 x i128]* nonnull align 512 %X1_copy4, [8 x i32]* %4, [2 x i128]* nonnull align 512 %X2_copy5, [8 x i32]* %5, [2 x i128]* nonnull align 512 %D_copy6)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a8i32.15.16([2 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [8 x i32]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([8 x i32]* readonly "orig.arg.no"="0", [2 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [8 x i32]* readonly "orig.arg.no"="2", [2 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [8 x i32]* readonly "orig.arg.no"="4", [2 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5", [8 x i32]* readonly "orig.arg.no"="6", [2 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7", [8 x i32]* readonly "orig.arg.no"="8", [2 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="9", [8 x i32]* readonly "orig.arg.no"="10", [2 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="11") #3 {
entry:
  call void @onebyonecpy_hls.p0a8i32.15.16([2 x i128]* align 512 %1, [8 x i32]* %0)
  call void @onebyonecpy_hls.p0a8i32.15.16([2 x i128]* align 512 %3, [8 x i32]* %2)
  call void @onebyonecpy_hls.p0a8i32.15.16([2 x i128]* align 512 %5, [8 x i32]* %4)
  call void @onebyonecpy_hls.p0a8i32.15.16([2 x i128]* align 512 %7, [8 x i32]* %6)
  call void @onebyonecpy_hls.p0a8i32.15.16([2 x i128]* align 512 %9, [8 x i32]* %8)
  call void @onebyonecpy_hls.p0a8i32.15.16([2 x i128]* align 512 %11, [8 x i32]* %10)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a8i32.21.22([8 x i32]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [2 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([8 x i32]* "orig.arg.no"="0", [2 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [8 x i32]* "orig.arg.no"="2", [2 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [8 x i32]* "orig.arg.no"="4", [2 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5", [8 x i32]* "orig.arg.no"="6", [2 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7", [8 x i32]* "orig.arg.no"="8", [2 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="9", [8 x i32]* "orig.arg.no"="10", [2 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="11") #4 {
entry:
  call void @onebyonecpy_hls.p0a8i32.21.22([8 x i32]* %0, [2 x i128]* align 512 %1)
  call void @onebyonecpy_hls.p0a8i32.21.22([8 x i32]* %2, [2 x i128]* align 512 %3)
  call void @onebyonecpy_hls.p0a8i32.21.22([8 x i32]* %4, [2 x i128]* align 512 %5)
  call void @onebyonecpy_hls.p0a8i32.21.22([8 x i32]* %6, [2 x i128]* align 512 %7)
  call void @onebyonecpy_hls.p0a8i32.21.22([8 x i32]* %8, [2 x i128]* align 512 %9)
  call void @onebyonecpy_hls.p0a8i32.21.22([8 x i32]* %10, [2 x i128]* align 512 %11)
  ret void
}

declare void @apatb_kp_502_7_hw([2 x i128]*, [2 x i128]*, [2 x i128]*, [2 x i128]*, [2 x i128]*, [2 x i128]*)

define void @kp_502_7_hw_stub_wrapper([2 x i128]*, [2 x i128]*, [2 x i128]*, [2 x i128]*, [2 x i128]*, [2 x i128]*) #5 {
entry:
  %6 = alloca [8 x i32]
  %7 = alloca [8 x i32]
  %8 = alloca [8 x i32]
  ...
  %10 = alloca [8 x i32]
  %11 = alloca [8 x i32]
  call void @copy_out([8 x i32]* %6, [2 x i128]* %0, [8 x i32]* %7, [2 x i128]* %1, [8 x i32]* %8, [2 x i128]* %2, [8 x i32]* %9, [2 x i128]* %3, [8 x i32]* %10, [2 x i128]* %4, [8 x i32]* %11, [2 x i128]* %5)
  ...
  call void @copy_in([8 x i32]* %6, [2 x i128]* %0, [8 x i32]* %7, [2 x i128]* %1, [8 x i32]* %8, [2 x i128]* %2, [8 x i32]* %9, [2 x i128]* %3, [8 x i32]* %10, [2 x i128]* %4, [8 x i32]* %11, [2 x i128]* %5)
  ret void
}
...
!15 = !DIFile(filename: "G:/Xilinx_lab/KP_502_7_v3_2/kp_502_7/sol2_4/.autopilot/db\5Ckp_502_7.pp.0.cpp", directory: "G:\5CXilinx_lab\5CKP_502_7_v3_2")
!16 = !{!17, !24}
