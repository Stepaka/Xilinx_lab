...
tr.reorder();
tr.send<4>((char*)__xlx_apatb_param_X1, 8);
}
#else
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > X1_pc_buffer(8);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 8; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_X1)[j*4+0] = X1_pc_buffer[i].range(7, 0).to_int64();
((char*)__xlx_apatb_param_X1)[j*4+1] = X1_pc_buffer[i].range(15, 8).to_int64();
((char*)__xlx_apatb_param_X1)[j*4+2] = X1_pc_buffer[i].range(23, 16).to_int64();
((char*)__xlx_apatb_param_X1)[j*4+3] = X1_pc_buffer[i].range(31, 24).to_int64();
}}}
        } // end transaction
      } // end file is good
...
tr.reorder();
tr.send<4>((char*)__xlx_apatb_param_X2, 8);
}
#else
{
      static ifstream rtl_tv_out_file;
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > X2_pc_buffer(8);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 8; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_X2)[j*4+0] = X2_pc_buffer[i].range(7, 0).to_int64();
((char*)__xlx_apatb_param_X2)[j*4+1] = X2_pc_buffer[i].range(15, 8).to_int64();
((char*)__xlx_apatb_param_X2)[j*4+2] = X2_pc_buffer[i].range(23, 16).to_int64();
((char*)__xlx_apatb_param_X2)[j*4+3] = X2_pc_buffer[i].range(31, 24).to_int64();
}}}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
...
tr.reorder();
tr.send<4>((char*)__xlx_apatb_param_D, 8);
}
#else
{
      static ifstream rtl_tv_out_file;
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > D_pc_buffer(8);
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 8; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_D)[j*4+0] = D_pc_buffer[i].range(7, 0).to_int64();
((char*)__xlx_apatb_param_D)[j*4+1] = D_pc_buffer[i].range(15, 8).to_int64();
((char*)__xlx_apatb_param_D)[j*4+2] = D_pc_buffer[i].range(23, 16).to_int64();
((char*)__xlx_apatb_param_D)[j*4+3] = D_pc_buffer[i].range(31, 24).to_int64();
}}}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
...
tr.import<4>((char*)__xlx_apatb_param_X1, 8, 0);
  }
tr.reorder();
...
transaction<32> tr(8);
  __xlx_offset_byte_param_X2 = 0*4;
  if (__xlx_apatb_param_X2) {
tr.import<4>((char*)__xlx_apatb_param_X2, 8, 0);
  }
tr.reorder();
...
transaction<32> tr(8);
  __xlx_offset_byte_param_D = 0*4;
  if (__xlx_apatb_param_D) {
tr.import<4>((char*)__xlx_apatb_param_D, 8, 0);
  }
tr.reorder();
...
aesl_fh.write(AUTOTB_TVIN_D, begin_str(AESL_transaction));
{
  ...
  if (__xlx_apatb_param_D) {
    for (int j = 0  - 0, e = 8 - 0; j != e; ++j) {
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_D)[j];
