...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "25", "EstimateLatencyMax" : "345",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Loop" : [
			{"Name" : "Loop", "PipelineType" : "no",
				"LoopDec" : {"FSMBitwidth" : "79", "FirstState" : "ap_ST_fsm_state2", "LastState" : ["ap_ST_fsm_state44"], "QuitState" : ["ap_ST_fsm_state2"], "PreState" : ["ap_ST_fsm_state1"], "PostState" : ["ap_ST_fsm_state1"], "OneDepthLoop" : "0", "OneStateBlock": ""}}]},
...
set ArgLastReadFirstWriteLatency {
	kp_502_7 {
		...
		X1 {Type O LastRead -1 FirstWrite 2}
		X2 {Type O LastRead -1 FirstWrite 2}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "25", "Max" : "345"}
	, {"Name" : "Interval", "Min" : "26", "Max" : "346"}
]}
