...
foreach the_solution $all_solutions {
  ...
  if {$the_solution == "sol2_1"} {
	...
	set_directive_interface -mode ap_memory -storage_type ram_2p "kp_502_7" x
  }
  ...
  if {$the_solution == "sol2_2"} {
	...
	set_directive_interface -mode ap_memory -storage_type ram_1p "kp_502_7" x
	...
	set_directive_array_partition -dim 1 -factor 2 -type cyclic "kp_502_7" x
	set_directive_array_partition -dim 1 -factor 2 -type cyclic "kp_502_7" r
  }
  ...
  if {$the_solution == "sol2_3"} {
	...
	set_directive_array_partition -dim 1 -factor 4 -type cyclic "kp_502_7" x
	set_directive_array_partition -dim 1 -factor 4 -type cyclic "kp_502_7" r
  }
  ...
  if {$the_solution == "sol2_4"} {
	...
	set_directive_array_reshape -dim 1 -factor 4 -type cyclic "kp_502_7" x
	set_directive_array_reshape -dim 1 -factor 4 -type cyclic "kp_502_7" r
  }
  ...
  if {$the_solution == "sol2_5" || $the_solution == "sol2_6"} {
	...
	set_directive_array_partition -dim 1 -factor 8 -type cyclic "kp_502_7" x
	set_directive_array_partition -dim 1 -factor 8 -type cyclic "kp_502_7" r
  }
