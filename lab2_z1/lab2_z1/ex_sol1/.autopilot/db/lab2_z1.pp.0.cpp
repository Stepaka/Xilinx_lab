...
# 2 "<built-in>" 2
# 1 "./source/lab2_z1.cpp" 2
# 1 "./source/lab2_z1.h" 1
typedef unsigned char din_type;
typedef unsigned int dout_type;

__attribute__((sdx_kernel("lab2_z1", 0))) dout_type lab2_z1 (din_type n);
# 2 "./source/lab2_z1.cpp" 2

__attribute__((sdx_kernel("lab2_z1", 0))) dout_type lab2_z1 (din_type n)
{
#pragma HLSDIRECTIVE TOP name=lab2_z1
# 4 "./source/lab2_z1.cpp"

 dout_type fact = 1;
 VITIS_LOOP_6_1: for(int i = 1; i <= n; i++)
 {
