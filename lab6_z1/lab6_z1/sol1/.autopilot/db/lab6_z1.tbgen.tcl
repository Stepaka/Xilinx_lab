...
set C_modelArgList {
	{ a int 16 regular {array 32 { 0 3 } 0 1 }  }
	{ b int 16 regular {array 32 { 1 3 } 1 1 }  }
	{ c int 16 regular {array 32 { 1 3 } 1 1 }  }
}
...
set Spec2ImplPortList { 
	a { ap_memory {  { a_address0 mem_address 1 5 }  { a_ce0 mem_ce 1 1 }  { a_we0 mem_we 1 1 }  { a_d0 mem_din 1 16 } } }
	b { ap_memory {  { b_address0 mem_address 1 5 }  { b_ce0 mem_ce 1 1 }  { b_q0 in_data 0 16 } } }
	c { ap_memory {  { c_address0 mem_address 1 5 }  { c_ce0 mem_ce 1 1 }  { c_q0 in_data 0 16 } } }
}
